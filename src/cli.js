...
targets
  ...
  .option('--auth-needs-scout-summary <path>', 'Resolved auth needs-scout pack summary JSON path')
  .option('--auth-needs-scout <path>', 'Resolved auth needs-scout pack CSV path')
  .option('--auth-needs-scout-lane-size <n>', 'Rows per resolved auth needs-scout lane', '10')
  .option('--auth-manual-review-summary <path>', 'Resolved auth manual-review pack summary JSON path')
  .option('--auth-manual-review <path>', 'Resolved auth manual-review pack CSV path')
  .option('--auth-manual-review-lane-size <n>', 'Rows per resolved auth manual-review lane', '10')
  .option('--auth-manual-review-fail-closed-lane-size <n>', 'Rows per fail-closed auth manual-review lane', '10')
