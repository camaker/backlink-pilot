...
Invoke-ManualLogin -Order '1' -TargetId 'chatgptdemo' -Name 'ChatGPT demo' -Domain 'chatgptdemo.com' -Profile 'chatgptdemo' -LoginUrl 'https://chatgptdemo.com/submit-new-ai-tool'
Invoke-ManualLogin -Order '2' -TargetId 'promptzone' -Name 'Promptzone' -Domain 'promptzone.com' -Profile 'promptzone' -LoginUrl 'https://www.promptzone.com/new'
Invoke-ManualLogin -Order '3' -TargetId 'resource-fyi' -Name 'Resource fyi' -Domain 'resource.fyi' -Profile 'resource-fyi' -LoginUrl 'https://resource.fyi/login'
Invoke-ManualLogin -Order '4' -TargetId 'sitelike' -Name 'Sitelike' -Domain 'sitelike.org' -Profile 'sitelike' -LoginUrl 'https://www.sitelike.org/add-site'
Invoke-ManualLogin -Order '5' -TargetId 'ai-tool-guru' -Name 'AI Tool guru' -Domain 'aitoolguru.com' -Profile 'ai-tool-guru' -LoginUrl 'https://aitoolguru.com/login'
Invoke-ManualLogin -Order '6' -TargetId 'ai-tools-arena' -Name 'AI Tools Arena' -Domain 'aitoolsarena.com' -Profile 'ai-tools-arena' -LoginUrl 'https://aitoolsarena.com/ai-tools-list-new'
Invoke-ManualLogin -Order '7' -TargetId 'alternative-me' -Name 'Alternative' -Domain 'alternative.me' -Profile 'alternative-me' -LoginUrl 'https://alternative.me/how-to/suggest-alternatives'
Invoke-ManualLogin -Order '8' -TargetId 'bestofai' -Name 'BestOfAI' -Domain 'bestofai.com' -Profile 'bestofai' -LoginUrl 'https://bestofai.com/tool/add'
Invoke-ManualLogin -Order '9' -TargetId 'f6s' -Name 'F6S' -Domain 'f6s.com' -Profile 'f6s' -LoginUrl 'https://www.f6s.com/'
Invoke-ManualLogin -Order '10' -TargetId 'favird' -Name 'Favird' -Domain 'favird.com' -Profile 'favird' -LoginUrl 'https://favird.com/'
