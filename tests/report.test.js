...
`);
      ...
      assert.match(report.next_actions.find(action => action.id === 'work_directory_coverage_backlog').command, /validate-coverage-review-batch|targets backlog-worker|targets backlog-lane/);
